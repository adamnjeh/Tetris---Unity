...
public static class Data
{
    ...
    public static readonly float[] RotationMatrix = new float[] { cos, sin, -sin, cos }; // rotation matrix used to rotate cells 

    // cells positions mapped to the tetromino type
    ...
    // all possible walkicks for I piece as shown in this table guide : https://tetris.fandom.com/wiki/SRS
    ...
    // all possible walkicks for the rest of pieces as shown in this table guide : https://tetris.fandom.com/wiki/SRS
    ...
    // mapping each piece with the correspandant wallkicks
